...
const projects = [
  ...
  },
  {
    ...
    skills: [SKILLS.PYTHON, SKILLS.ARTICLE, SKILLS.ALGORITHM],
    description:
  ...
  },
  {
    ...
    skills: [SKILLS.JAVA, SKILLS.JS, SKILLS.REACT, SKILLS.ALGORITHM],
    description:
  ...
  },
  {
    ...
    description:
      "Web application to buy a ticker for a movie theater with concurrency while picking chairs using Scrum methodology",
    observation: "choose to learn more",
    loc: "4k",
    imgUrl: theater,
  },
  {
    title: "Eyeweather",
    skills: [SKILLS.SPRING, SKILLS.JS, SKILLS.BOOTSTRAP, SKILLS.API],
    description:
